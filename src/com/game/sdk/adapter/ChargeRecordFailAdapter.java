...
public class ChargeRecordFailAdapter extends BaseAdapter {
	...
	public ChargeRecordFailAdapter(Context mContext, List<ChargeRecord> list,CancelConfigDialog cancelDialog) {
		super();
