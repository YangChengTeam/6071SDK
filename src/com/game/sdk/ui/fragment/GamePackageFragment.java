...
public class GamePackageFragment extends BaseFragment implements OnClickListener, DownApkListener, OnScrollListener {
		...
		public void handleMessage(Message msg) {
			...
			case 2:
				...
				if (gamePackageDetailList != null && gamePackageDetailList.size() == 0) {
					...
					noMoreTv.setPadding(0, DimensionUtil.dip2px(mainActivity, 8), 0,
							DimensionUtil.dip2px(mainActivity, 8));
				}
	...
	public String getLayoutId() {
		return "fysdk_game_package_fragment";
	}
	...
	public void initViews() {
		...
		loadMoreView = mainActivity.getLayoutInflater()
				.inflate(MResource.getIdByName(mainActivity, "layout", "list_view_footer"), null);
		loadMoreLayout = (LinearLayout) loadMoreView
				.findViewById(MResource.getIdByName(mainActivity, "id", "load_more_layout"));
		noMoreLayout = (LinearLayout) loadMoreView
				.findViewById(MResource.getIdByName(mainActivity, "id", "no_more_layout"));
		...
		gamePackageDetailEngin = GamePackageDetailEngin.getImpl(mainActivity);
	...
	public void initData() {
		...
		adapter = new GamePackageDetailAdapter(mainActivity, gamePackageDetailList);
