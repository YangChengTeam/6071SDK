...
import com.game.sdk.adapter.ChargeRecordSuccessAdapter;
import com.game.sdk.adapter.ChargeRecordSuccessAdapter.ContinuePayListener;
...
public class ChargeRecordSuccessFragment extends BaseFragment implements OnClickListener, ContinuePayListener, CancelListener, OnScrollListener,PayResultListener{
	
	private ChargeRecordActivity mainActivity;
	
	private ListView listView;

	private ChargeRecordSuccessAdapter adapter;
	...
	public void initData() {
		...
		adapter = new ChargeRecordSuccessAdapter(mainActivity, chargeRecordList, cancelConfigDialog);
